...
public class TopicosController {
	...
	public ResponseEntity<TopicoDto> cadastrar(@Valid @RequestBody TopicoForm form, UriComponentsBuilder builder) {
	...
	public ResponseEntity<DetalhesDoTopicoDto> detalhar(@PathVariable Long id) {
		...
		if(topico.isPresent()) {
			Topico topico2 = topico.get();
			return ResponseEntity.ok(new DetalhesDoTopicoDto(topico2));
		}
	...
	public ResponseEntity<TopicoDto> atualizar(@PathVariable Long id, @RequestBody @Valid AtualizacaoTopicoForm form) {
		Optional<Topico> dto = topicoRepository.findById(id);
		if(dto.isPresent()) {
	...
	public ResponseEntity<TopicoDto> deletar(@PathVariable Long id) {
		Optional<Topico> opicional = topicoRepository.findById(id);
